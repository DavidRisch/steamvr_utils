...
def create_desktop_file(action):
    command = 'python3 {} {}'.format(os.path.join(os.path.dirname(__file__), 'steamvr_utils.py'), action)
...
def main():
    ...
    create_desktop_file('on')
    create_desktop_file('off')
